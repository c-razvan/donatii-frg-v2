<?php 
$mid="44840997207";
$key="B24D8881017850F2F3C4E408F3DA123C67287433";
...
<?php 
if($_POST['recurent']=='yes') { ?>
<input type="text" NAME="recurent" VALUE="Base" />
<input type="hidden" NAME="recurent_freq" VALUE="<?php echo  $dataAll['recurent_freq'] ?>" />
<input type="hidden" NAME="recurent_exp" VALUE="<?php echo  $dataAll['recurent_exp'] ?>" />
<?php } ?>
</form>                                                                 
...
<p><a href="javascript:gateway();" class="txtCheckout">Go Now!</a></p>
